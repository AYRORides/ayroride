        ...
        <main>
            ...
            <section className={styles.contentSection}>
                <div className={styles.contentContainer}>
                    ...
                    <p>The Ayro website and its associated services, products, software, and content (collectively “Services”) is owned and operated by Ayro Inc. (“Ayro”, “our”, “us”, “we”), a Delaware corporation. Ayro has adopted this Terms of Service Agreement (“Agreement”) to inform you (“User(s)”) of your rights and duties when using the Services. If you do not agree with the terms and conditions of this Agreement, you are expressly prohibited from using the Services and must discontinue your use immediately.</p>

                    <p className={styles.warningText}>AYRO MAY, FROM TIME TO TIME, AND RESERVES THE RIGHT, IN ITS SOLE AND ABSOLUTE DISCRETION, TO MODIFY, LIMIT, CHANGE, DISCONTINUE, OR REPLACE THE SERVICES OR THIS AGREEMENT. IN THE EVENT AYRO MODIFIES, LIMITS, CHANGES, OR REPLACES THE SERVICES OR THIS AGREEMENT, YOUR USE OF THE SERVICES AFTER SAID MODIFICATION, LIMITATION, CHANGE, OR REPLACEMENT CONSTITUTES YOUR MANIFESTATION OF ASSENT TO THE MODIFICATION, LIMITATION, CHANGE, OR REPLACEMENT.</p>
                    ...
                    <ul className={styles.iconList}>
                        ...
                        <li className={styles.iconListItem}>
                            ...
                            <span className={styles.listText}><b>“Services” </b> means the Ayro website, products, and any associated services, software, or content.</span>
                        </li>
                        <li className={styles.iconListItem}>
                            <span className={styles.iconWrapper}>
                                <svg aria-hidden="true" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>
                    ...
                    <ul className={styles.iconList}>
                        {[
                            ...
                            "You represent that you are not a resident of, or otherwise accessing the Services from, any jurisdiction subject to comprehensive U.S. trade sanctions or export restrictions, including but not limited to Cuba, Iran, North Korea, Syria, or the Crimea region. You also represent that you are not listed on any U.S. government list of prohibited or restricted parties, such as the Specially Designated Nationals and Blocked Persons List (SDN List), and are not using the Services for the benefit of any such person or entity. Ayro does not support Users located in or accessing the Services from jurisdictions subject to comprehensive U.S. sanctions",
                            "You agree to use the Services in good faith and in a manner consistent with its intended purpose. You will not attempt to undermine, circumvent, or exploit the Services’ functionality, review systems, or technical safeguards.  The Services is operated in the United States. If you access the Services from outside the United States, you consent to the transfer, storage, and processing of your data in the United States. Ayro makes no representation that the Services is appropriate or available for use in other jurisdictions, and access from jurisdictions where such access is illegal is prohibited.",
                            "Ayro reserves the right, but not the obligation, to monitor the Services for violations of this Agreement, to take appropriate legal action against anyone who violates this Agreement (including reporting such User to law enforcement authorities), and to otherwise manage the Services in a manner designed to protect Ayro’s rights and property and to facilitate the proper functioning of the Services."
                        ].map((text, index) => (
                    ...
                    <p>Ayro may, from time to time, offer access to the Services that is classified as Beta version. Ayro makes no representations that a Beta version will ever be made generally available and reserves the right to discontinue or modify a Beta version of the Services at any time without notice. Beta versions of the Services is provided AS IS, and may contain bugs, errors, or other defects. Your use of a Beta version is at your sole risk.</p>
                    <p>Ayro will make commercially reasonable efforts to maintain access to the Services. However, you acknowledge and agree that Ayro may suspend, restrict, or disable access to the Services or any part thereof at any time and without notice, including for maintenance, updates, security patches, or events beyond its control, such as network failures, third-party service outages, force majeure events, legal or compliance obligations, or denial-of-service attacks.</p>
                    <p>Ayro makes no guarantees regarding the availability, uptime, or uninterrupted access to the Services, and shall not be liable for any loss, damage, or inconvenience suffered as a result of any downtime, delay, or unavailability. You acknowledge that Ayro has no obligation to maintain or support the Services for any minimum period of time.</p>

                    <h3>Ownership of Services and License</h3>
                    <p>You acknowledge and agree that Ayro is the sole and exclusive owner of, or otherwise possesses valid rights in and to, the Services and all elements thereof, including but not limited to the codebase, software architecture, content, APIs, documentation, interfaces, text, design, artwork, graphics, metadata schemas, look and feel, layout, and all content, trade dress, and branding therein or related thereto. Ayro hereby grants you a limited, non-exclusive, non-sublicensable, royalty free, non-assignable, and revocable license to use the Services for its customary and intended purposes. Violation of the terms of this Agreement or use of the Services for a use outside of its customary and intended purposes, such as, but not limited to downloading (other than page caching) or modifying the Services or any portion of it will result in the termination of this license.  Absent prior written permission from Ayro, you are not permitted to reproduce, prepare derivative works, distribute copies, perform, display, or use for commercial purposes the Services or its content.  This license is revocable at any time, and any rights not expressly granted herein are reserved to Ayro. </p>

                    <h3>Intellectual Property</h3>
                    <p>All trademarks (common law or registered), copyrights (common law or registered), and proprietary rights in and to the Services are the property of Ayro. All Ayro marks are the property of Ayro, including, but not limited to AYRO, and all Ayro logos. The Services, including its look and feel, color selections, layout, and arrangement, is the trade dress of Ayro. You are prohibited from using Ayro’s trademarks, service marks, and trade dress, or any colorable imitation thereof, to indicate the source of, sponsorship of, approval of, affiliation with, connection with, or association with your goods or services without the prior written consent of Ayro. Ayro reserves the right to revoke or condition any permissions granted at its sole discretion.</p>
                    ...
                    <p>You have a duty to ensure that the information provided through the Services is truthful, current, complete, and accurate. You understand and agree that you have an ongoing duty to update and keep current the information provided through the Services if and when that information changes. You are expressly prohibited from providing information that in a way impersonates another person, contains offensive or obscene language, or otherwise violates the rights of a third party. You expressly agree that you will not interfere with or disrupt a third party’s enjoyment and use of the Services. Ayro reserves the right to restrict access to, monitor, suspend, disable, or delete Users’ information at any time, in its sole discretion, and without prior warning. You further acknowledge that Ayro has no obligation to monitor or moderate activity but reserves the right to do so for the protection of the Services and its users. You agree to hold harmless and indemnify Ayro for any damages that arise out of or in relation to the use of the Services.</p>
                    ...
                    <p>In the event Ayro provides access to the Services via a mobile device: to the extent you access the Services through a mobile device, your wireless carrier’s standard charges, rates, and fees may apply.  Ayro is not responsible for any data usage, roaming charges, or mobile-related fees or errors that occur while accessing the Services via mobile device.</p>

                    <h3>Section 230 of Communications Decency Act</h3>
                    <p>You acknowledge and agree that Ayro is an interactive computer service provider under Section 230 of the Communications Decency Act. Though Ayro may edit, remove, or control the content displayed through the Services, you agree that Ayro will not be considered an information content provider and will not be held liable for the republication of defamatory or tortious content created by third parties, whether through the Services or otherwise. You acknowledge and agree that Ayro is not responsible for, and does not endorse, any content embedded in or linked posted to the Services, even if such content remains accessible via the Services. </p>

                    <h3>Term and Termination</h3>
                    <p>This Agreement will remain in full force and effect so long as the Services is in operation.  Ayro may terminate this Agreement without liability at any time, without notice, and for any reason, including but not limited to for your violation of a term or condition of this Agreement. Upon termination of this Agreement, your right to use the Services will immediately cease. Ayro will have no obligation to maintain or preserve any data, submissions, or transaction history following termination, except as required by law or our Privacy Policy.</p>
                    ...
                    <p className={styles.warningText}>AYRO DISCLAIMS ANY RESPONSIBILITY FOR ANY HARM OR LIABILITY ARISING OUT OF OR RELATED TO YOUR USE OF THE SERVICES. AYRO DOES NOT WARRANT THAT THE SERVICES WILL BE ERROR-FREE, UNINTERRUPTED, OR FREE OF VIRUSES, MALWARE, OR OTHER HARMFUL COMPONENTS. AYRO PROVIDES THE SERVICES ON AN AS-IS BASIS AND WITHOUT WARRANTY OF ANY KIND, WHETHER EXPRESS, IMPLIED, OR STATUTORY, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, ACCURACY, COMPLETENESS, NON-INFRINGEMENT, OR QUALITY. SOME JURISDICTIONS DO NOT ALLOW AN EXCLUSION OF IMPLIED WARRANTIES. IF YOU ARE LOCATED IN SUCH A JURISDICTION, THIS EXCLUSION MAY NOT APPLY.</p>
                    <p className={styles.warningText}>AYRO WILL NOT BE HELD LIABLE OR RESPONSIBLE TO YOU FOR ANY LOSS AND TAKE NO RESPONSIBILITY FOR, AND WILL NOT BE LIABLE TO YOU FOR; ANY USE OF THE SERVICES OR CONTENT, INCLUDING BUT NOT LIMITED TO ANY LOSSES, DAMAGES, OR CLAIMS ARISING FROM: (A) USER ERROR, INCORRECTLY CONSTRUCTED TRANSACTIONS, OR MISTYPED ADDRESSES; (B) SERVER FAILURE OR DATA LOSS; (C) UNAUTHORIZED ACCESS OR USE; (D) ANY UNAUTHORIZED THIRD-PARTY ACTIVITIES, INCLUDING WITHOUT LIMITATION THE USE OF VIRUSES, HACKING, PHISHING, BRUTE FORCING OR OTHER MEANS OF ATTACK AGAINST THE SERVICES.</p>
                    <p className={styles.warningText}>AYRO WILL NOT BE HELD LIABLE OR RESPONSIBLE FOR ANY CONTENT POSTED ON THE SERVICES, ANY THIRD-PARTY LINKS POSTED ON THE SERVICES, OR ANY CONTENT TRANSMITTED THROUGH THE SERVICES. AYRO IS A SERVICE PROVIDER AND DOES NOT ASSUME RESPONSIBILITY FOR ANY ERROR, OMISSION, INTERRUPTION, DELETION, DEFECT, ALTERATION, AND/OR DESTRUCTION OF IDENTITY. AYRO RESERVES THE RIGHT TO DISCONTINUE THE SERVICES AT ANY TIME.</p>
                    <p className={styles.warningText}>AYRO DOES NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SERVICES, ANY HYPERLINKED SERVICES, OR ANY SERVICES OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING. AYRO WILL NOT BE A PARTY TO OR IN ANY WAY RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AYRO WILL NOT BE HELD LIABLE FOR NETWORK, INTERNET, COMPUTER, HARDWARE, OR SOFTWARE PROGRAM MALFUNCTIONS, FAILURE, DELAYS, OR DIFFICULTIES WITH THE SERVICES AT ANY TIME.</p>
                    ...
                    <p className={styles.warningText}>AYRO WILL NOT BE LIABLE TO YOU UNDER ANY LEGAL THEORY FOR ANY DAMAGES, CLAIMS, INJURIES, JUDGMENTS, COSTS, OR LIABILITIES ARISING OUT OF OR RELATED TO YOUR USE OR MISUSE OF THE SERVICES INCLUDING, BUT NOT LIMITED TO, LOSS OF BUSINESS, LOSS OF INCOME, SPECIAL DAMAGES, INCIDENTAL DAMAGES, CONSEQUENTIAL DAMAGES, PUNITIVE DAMAGES, OR EXEMPLARY DAMAGES.</p>
                    <p className={styles.warningText}>YOU UNDERSTAND AND AGREE THAT THE MAXIMUM AMOUNT THAT AYRO CAN BE HELD LIABLE TO YOU UNDER ANY CIRCUMSTANCE IS THE AMOUNT THAT YOU PAID, IF ANY, FOR THE SERVICES, AND SPECIFICALLY, FOR THE INDIVIDUAL CONTENT, PRODUCT, OR SUBSCRIPTION GIVING RISE TO THE CLAIM. IN NO CASE SHALL AYRO’S CUMULATIVE LIABILITY EXCEED THE GREATER OF (A) THE AMOUNT PAID, IF ANY, BY YOU TO USE DURING THE TWELVE (12) MONTH PERIOD PRIOR TO THE EVENT OR CIRCUMSTANCE GIVING RISE TO THE CLAIM; OR (B) $100.</p>
                    <p className={styles.warningText}>THE SERVICES MAY CONTAIN TECHNICAL INACCURACIES OR TYPOGRAPHICAL ERRORS OR OMISSIONS. AYRO IS NOT RESPONSIBLE FOR ANY SUCH TYPOGRAPHICAL, TECHNICAL, OR PRICING ERRORS LISTED ON THE SERVICES. THE FOREGOING LIMITATIONS OF LIABILITY ARE AN ESSENTIAL ELEMENT OF THE BASIS OF THE BARGAIN BETWEEN YOU AND AYRO. THESE LIMITATIONS APPLY EVEN IF ANY LIMITED REMEDY FAILS OF ITS ESSENTIAL PURPOSE.</p>
                    ...
                    <p>The Services is not directed to persons under the age of eighteen (18) and Ayro will not knowingly collect personally identifiable information from children under the age of eighteen (18) for the creation of User accounts. If Ayro inadvertently collects such personally identifiable information outside of the purposes of the Services, Ayro will delete the personally identifiable information in accordance with its security protocols.</p>
                    ...
                    <p className={styles.warningText}>AYRO AND YOU BOTH AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE SERVICES MUST COMMENCE WITHIN ONE YEAR AFTER THE CAUSE OF ACTION ACCRUES. FAILURE TO ASSERT SAID CAUSE OF ACTION WITHIN ONE YEAR WILL PERMANENTLY BAR ANY AND ALL RELIEF.</p>
                    <p className={styles.warningText}>YOU WILL ONLY BE PERMITTED TO PURSUE CLAIMS AGAINST AYRO ON AN INDIVIDUAL BASIS, NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY CLASS OR REPRESENTATIVE ACTION OR PROCEEDING AND YOU WILL ONLY BE PERMITTED TO SEEK RELIEF (INCLUDING MONETARY, INJUNCTIVE, AND DECLARATORY RELIEF) ON AN INDIVIDUAL BASIS.</p>

                    <h3>Reservation of Rights</h3>
                    <p>All rights not expressly granted herein are reserved to Ayro. </p>

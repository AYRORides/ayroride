                ...
                <a href="#" target="_blank" rel="noopener noreferrer">
                  ...
                  >
                    <rect
                      ...
                      height="28"
                      rx="6"
                      fill="url(#paint0_radial_5_16341_custom)"
                    />
                    <rect
                      x="2"
                      y="2"
                      ...
                      height="28"
                      rx="6"
                      fill="url(#paint1_radial_5_16341_custom)"
                    />
                    <rect
                      x="2"
                      y="2"
                      ...
                      height="28"
                      rx="6"
                      fill="url(#paint2_radial_5_16341_custom)"
                    />
                    <path
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M6 15.6C6 12.2397 6 10.5595 6.65396 9.27606C7.2292 8.14708 8.14708 7.2292 9.27606 6.65396C10.5595 6 12.2397 6 15.6 6H16.4C19.7603 6 21.4405 6 22.7239 6.65396C23.8529 7.2292 24.7708 8.14708 25.346 9.27606C26 10.5595 26 12.2397 26 15.6V16.4C26 19.7603 26 21.4405 25.346 22.7239C24.7708 23.8529 23.8529 24.7708 22.7239 25.346C21.4405 26 19.7603 26 16.4 26H15.6C12.2397 26 10.5595 26 9.27606 25.346C8.14708 24.7708 7.2292 23.8529 6.65396 22.7239C6 21.4405 6 19.7603 6 16.4V15.6ZM15.6 8H16.4C18.1132 8 19.2777 8.00156 20.1779 8.0751C21.0548 8.14674 21.5032 8.27659 21.816 8.43597C22.5686 8.81947 23.1805 9.43139 23.564 10.184C23.7234 10.4968 23.8533 10.9452 23.9249 11.8221C23.9984 12.7223 24 13.8868 24 15.6V16.4C24 18.1132 23.9984 19.2777 23.9249 20.1779C23.8533 21.0548 23.7234 21.5032 23.564 21.816C23.1805 22.5686 22.5686 23.1805 21.816 23.564C21.5032 23.7234 21.0548 23.8533 20.1779 23.9249C19.2777 23.9984 18.1132 24 16.4 24H15.6C13.8868 24 12.7223 23.9984 11.8221 23.9249C10.9452 23.8533 10.4968 23.7234 10.184 23.564C9.43139 23.1805 8.81947 22.5686 8.43597 10.184C8.81947 9.43139 9.43139 8.81947 10.184 8.43597C10.4968 8.27659 10.9452 8.14674 11.8221 8.0751C12.7223 8.00156 13.8868 8 15.6 8Z"
                      fill="white"
                    />
                    <defs>
                      <radialGradient
                        id="paint0_radial_5_16341_custom"
                        cx="0"
                        cy="0"
                        r="1"
                      ...
                      <radialGradient
                        id="paint1_radial_5_16341_custom"
                        cx="0"
                        cy="0"
                        r="1"
                        gradientUnits="userSpaceOnUse"
                      ...
                      <radialGradient
                        id="paint2_radial_5_16341_custom"
                        cx="0"
                        cy="0"
                        r="1"
                        gradientUnits="userSpaceOnUse"
